# Description:
#   RMS rants from the Stallman on Steroids forum bot.
#   Pasta source: https://www.gnu.org/philosophy/words-to-avoid.html
#
# Dependencies:
#   None
#
...
module.exports = (robot) ->
  robot.hear /linux/i, (msg) ->
    msg.send linux_pasta

  robot.hear /arch/i, (msg) ->
    msg.send arch_pasta

  robot.hear /centos/i, (msg) ->
    msg.send centos_pasta

  robot.hear /debian/i, (msg) ->
    msg.send debian_pasta

  robot.hear /fedora/i, (msg) ->
    msg.send fedora_pasta

  robot.hear /gentoo/i, (msg) ->
    msg.send gentoo_pasta

  robot.hear /mandriva/i, (msg) ->
    msg.send mandriva_pasta

  robot.hear /opensuse/i, (msg) ->
    msg.send opensuse_pasta

  robot.hear /slackware/i, (msg) ->
    msg.send slackware_pasta

  robot.hear /ubuntu/i, (msg) ->
    msg.send ubuntu_pasta

  robot.hear /photoshop/i, (msg) ->
    msg.send ps_pasta

  robot.hear /hacker/i, (msg) ->
    msg.send hacker_pasta

  robot.hear /intellectual property/i, (msg) ->
    msg.send ip_pasta

  robot.hear /\slamp/i, (msg) ->
    msg.send lamp_pasta

  robot.hear /software market/i, (msg) ->
    msg.send market_pasta

  robot.hear /give away software/i, (msg) ->
    msg.send give_pasta

  robot.hear /monetize/i, (msg) ->
    msg.send monetize_pasta

  robot.hear /mp3 player/i, (msg) ->
    msg.send mp3_pasta

  robot.hear /freeware/i, (msg) ->
    msg.send freeware_pasta

  robot.hear /commercial/i, (msg) ->
    msg.send commercial_pasta

  robot.hear /consumer/i, (msg) ->
    msg.send consumer_pasta

  robot.hear /closed source/i, (msg) ->
    msg.send closed_pasta

  robot.hear /content/i, (msg) ->
    msg.send content_pasta

  robot.hear /digital goods/i, (msg) ->
    msg.send digital_goods_pasta

  robot.hear /digital locks/i, (msg) ->
    msg.send digital_locks_pasta

  robot.hear /trusted computing/i, (msg) ->
    msg.send trustedcomp_pasta

  robot.hear /software industry/i, (msg) ->
    msg.send softwareindustry_pasta

  robot.hear /(powerpoint|\sppt)/i, (msg) ->
    msg.send powerpoint_pasta

  robot.hear /open source/i, (msg) ->
    msg.send open_pasta

  robot.hear /ecosystem/i, (msg) ->
    msg.send eco_pasta

  robot.hear /bsd( |-)style/i, (msg) ->
    msg.send bsdstyle_pasta

  robot.hear /(cloud computing|the cloud)/i, (msg) ->
    msg.send cloudcomp_pasta

  robot.hear /(redhat|red hat|rhel)/i, (msg) ->
    msg.send redhat_pasta

  robot.hear /(drm|digital rights management)/i, (msg) ->
    msg.send drm_pasta

  robot.hear /(\spc|\spcs)/i, (msg) ->
    msg.send pc_pasta

  robot.hear /(piracy|pirate)/i, (msg) ->
    msg.send piracy_pasta

  robot.hear /(drm|copyright) protection/i, (msg) ->
    msg.send protection_pasta

  robot.hear /(freebsd|openbsd|netbsd|bsd)/i, (msg) ->
    msg.send bsd_pasta

  robot.hear /(sell|selling) software/i, (msg) ->
    msg.send sellsoft_pasta

  robot.hear /vendor/i, (msg) ->
    msg.send vendor_pasta

  robot.hear /compensation/i, (msg) ->
    msg.send compensation_pasta

  robot.hear /consume\s/i, (msg) ->
    msg.send consume_pasta

  robot.hear /creative commons/i, (msg) ->
    msg.send creativecommons_pasta

  robot.hear /creator/i, (msg) ->
    msg.send creator_pasta

  robot.hear /floss/i, (msg) ->
    msg.send floss_pasta

  robot.hear /foss/i, (msg) ->
    msg.send foss_pasta

  robot.hear /for free/i, (msg) ->
    msg.send forfree_pasta

  robot.hear /freely available/i, (msg) ->
    msg.send freelyavailable_pasta

  robot.hear /google\s/i, (msg) ->
    msg.send google_pasta

  robot.hear /(saas|software as a service)/i, (msg) ->
    msg.send saas_pasta

  robot.hear /sharing economy/i, (msg) ->
    msg.send sharingeconomy_pasta

  robot.hear /skype/i, (msg) ->
    msg.send skype_pasta

  robot.hear /source model/i, (msg) ->
    msg.send sourcemodel_pasta

  robot.hear /theft/i, (msg) ->
    msg.send theft_pasta

  robot.hear /(fuck|screw|go away|die) (linux|stallman|gpl|rms|hubot|richard|linus)/i, (msg) ->
    msg.send seal_pasta

  robot.hear /((linux|stallman|gpl|rms|hubot|richard|linus) pls go|Shut your filthy hippy mouth,? (stallman|rms|hubot|richard|linus))/i, (msg) ->
    msg.send seal_pasta

  robot.hear /(linux|stallman|gpl|rms|hubot|richard|linus)\s+is\s+/i, (msg) ->
    msg.send seal_pasta
    
  robot.hear /(handsome|pretty|beautiful|stunning) (pic|picture)/i, (msg) ->
    rmsMe msg, (url) ->
      msg.send url

  robot.hear /(kawaii|cute|sexy|hot) (pic|picture)/i, (msg) ->
    msg.send msg.random sexy_pics

  robot.hear /(rms|richard|sexy|hot|cute|kawaii|handsome|pretty|beautiful|stunning|stallman) (bomb|mess)( (\d+))?/i, (msg) ->
    count = msg.match[4] || 5
    num = Math.min(handsome_pics.length + sexy_pics.length, count)
    clone = handsome_pics.concat(sexy_pics)
    for i in [0...num]
      randomIndex = randomNum(clone.length)
      image = clone.splice(randomIndex, 1)[0]
      msg.send image

rmsMe = (msg, cb) ->
  q = v: '1.0', rsz: '8', q: 'Richard Stallman', safe: 'active', imgsz: 'small|medium|large|xlarge', start: "#{randomNum 55}"
